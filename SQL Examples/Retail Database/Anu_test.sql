...
CREATE TABLE Customer(CustomerID int UNIQUE NOT NULL , CustomerName varchar(25) NOT NULL,
						...
						CustomerZipcode int NOT NULL, CustomerEmail varchar(25) UNIQUE NOT NULL,
						CustomerPassword varchar(25) NOT NULL, CustomerPhone varchar(15) UNIQUE,
						CONSTRAINT cusIDPK PRIMARY KEY(CustomerID));

CREATE TABLE CutomerAccount(BankAccountNumber int UNIQUE NOT NULL, BankName varchar(25) NOT NULL,
							BankRoutingNumber int NOT NULL, CustomerID int NOT NULL,
...
CREATE TABLE Supplier(SupplierID int UNIQUE NOT NULL, SupplierName varchar(25) NOT NULL,
						SupplierAddress varchar(45) NOT NULL, SupplierState varchar(20) NOT NULL,
						SupplierZipcode int NOT NULL, SupplierEmail varchar(25) UNIQUE NOT NULL,
						SupplierPhone varchar(15) UNIQUE NOT NULL,
						CONSTRAINT supIDPK PRIMARY KEY(SupplierID));
                   
CREATE TABLE SupplierAccount(BankAccountNumber int UNIQUE NOT NULL, BankName varchar(25) NOT NULL,
								BankRoutingNumber int NOT NULL, SupplierID int NOT NULL,
								CONSTRAINT BANS_PK PRIMARY KEY(BankAccountNumber),
								CONSTRAINT SupFK FOREIGN KEY(SupplierID)
								REFERENCES Supplier(SupplierID));


CREATE TABLE Item(ItemID int UNIQUE NOT NULL, ItemName int NOT NULL,
					ItemType varchar(25), ItemColor varchar(25),
